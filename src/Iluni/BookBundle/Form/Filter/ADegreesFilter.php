...
//use Iluni\BookBundle\Form\Type\CommonEntityType;
 ...
 */
class ADegreesFilter extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            //->add('strata', new CommonEntityType(), array(
            //  'class' => 'Iluni\BookBundle\Entity\Category\Strata',
            //  'empty_value' => '-- All Strata --'))
    ...
    {
        return 'iluni_bookbundle_adegreesfilter';
    }
}
